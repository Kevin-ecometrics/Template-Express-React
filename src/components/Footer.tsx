    ...
    return (
        <div className='overflow-x-hidden overflow-y-hidden md:h-[250px] bg-blue-600'>
            ...
            <div className='text-center px-4 py-4 md:px-12 md:py-12 text-white'>
                Todos los derechos reservados © 2024, thecondorvision.com desarrollado por
                <a href="https://ecommetrica.com" className='hover:text-blue-400 hover:underline font-semibold' target='_blank'>
                    {" "}Ecommetrica.com
                </a>
            </div>
        </div>
